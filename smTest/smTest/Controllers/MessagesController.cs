...
namespace smTest
{
    ...
    public class MessagesController : ApiController
    {
        ...
        public async Task<HttpResponseMessage> Post([FromBody]Activity activity)
        {
            ...
            var connectionString = <standard MongoDB URI>;
            var client = new MongoClient(connectionString);
            var db = client.GetDatabase(<Database Name>);
            IMongoCollection<MongoDBCreate.ProductDB> collection = db.GetCollection<MongoDBCreate.ProductDB>(<Collection Name>);
            ...
            if (activity.Type == ActivityTypes.Message)
            {
                ...
                {
                    // uriName is url decoded from the QRCode 
        ...
        // Parse product resume information
